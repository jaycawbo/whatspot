...
export default function SwipeDemo({ active, reducedMotion }) {
  const shouldBounce = active && !reducedMotion;
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        animate={shouldBounce ? { y: [0, -8, 0] } : { y: 0 }}
        transition={shouldBounce ? BOUNCE_TRANSITION : { duration: 0 }}
      >
